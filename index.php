...
<article class="home">
  <div class="hero">
    <img src="/images/ChymeraLogo.png" alt="hero" style="max-width:100%;border:1px solid #eee;padding:8px;background:#fff" />
    <h2>The CHyMErA Combinatorial Genome Editing System</h2>
    <br>
    <a class="btn-search" href="/search.php">Search for Guides</a> 
  </div>
  <br>
  ...
  <section class="diagram">
    <img src="/images/ChymeraMappingOfGeneticInteractionsv2.png" alt="diagram" />
  </section>
</article>
